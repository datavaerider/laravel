...
class MenuController extends Controller
{
    ...
    public function prosesTambah(Request $request){
        $this->validate($request,[
            ...
            'link_url' => 'required_if:jenis_menu,url', // Validasi untuk link_url jika jenis_menu adalah URL
        ]);

        $parent_menu = $request->parent_menu; // Memperbaiki penulisan variabel
        if($parent_menu == null){
            $urut = $this->getUrutanMenu();
        }else{
            $urut = $this->getUrutanMenu($parent_menu); // Menyediakan nilai parent_menu jika tidak null
        }
